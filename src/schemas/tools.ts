...
export const gestionarGastoSchema = z.object({
  accion: z
    .enum(GASTO_ACCIONES)
    .describe("Acción a realizar con los gastos"),
  datos: z.object({
    ...
    }).optional().describe("Filtros para obtener gastos específicos")
...
export const gestionarCategoriaSchema = z.object({
  ...
  datos: z.object({
    ...
    icono: z.string().optional().describe("Emoji que representa la categoría"),
  }).optional().describe("Datos para crear una nueva categoría")
});
...
export type ProcesarImagenReciboInput = z.infer<typeof procesarImagenReciboSchema>;
...
export const modificarGastoSchema = z.object({
  ...
  titulo: z
    .string()
    .optional()
    .describe("Nuevo título del gasto (opcional)"),
  precio: z
    .number()
    .positive("El precio debe ser mayor a 0")
    .optional()
...
export type ModificarGastoIndividualInput = z.infer<typeof modificarGastoSchema>;
export type CrearCategoriaIndividualInput = z.infer<typeof crearCategoriaSchema>;
export type ObtenerCategoriasIndividualInput = z.infer<typeof obtenerCategoriasSchema>;
